...
namespace Shop
{
    class Program
    {
        ...
        static void Main(string[] args) {
            ...
            Inventory CustomerItem = new Inventory();
            ...
            if(playerName == "") {
                Console.WriteLine("fine then your name is bubbles ");
                playerName = "bubbles";
            }
            ...
            CustomerItem.AddItem(HealthPotion);
            CustomerItem.AddItem(MagicPotion);
            CustomerItem.AddItem(HealthPotion);
            CustomerItem.AddItem(WoodenClub);
            ...
            StoreItem.AddItem(HealthPotion);
            StoreItem.AddItem(MagicPotion);
            StoreItem.AddItem(MagicPotion);
            StoreItem.AddItem(IronDagger);
            StoreItem.AddItem(DaedricHelm);
            StoreItem.AddItem(MageRobe);
            StoreItem.AddItem(AkaviriKatana);
            ...
            while (true)
            {
                ...
                do
                {
                    ...
                    ShowInventories(playerName, CustomerItem, StoreItem);
                ...
                DoTransaction(playerName, CustomerItem, StoreItem, doBuy);
